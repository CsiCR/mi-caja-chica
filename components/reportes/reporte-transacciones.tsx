              ...
              <div className="space-y-4">
                ...
                <div className="grid gap-3 text-xs">
                  ...
                  <div className="flex gap-2">
                    ...
                    <div>
                      <p className="font-medium">Ordenamiento Inteligente</p>
                      <p className="text-muted-foreground text-[10px]">Toca las cabeceras de la tabla para ordenar por fecha, monto o entidad.</p>
                    </div>
                  </div>
                </div>
